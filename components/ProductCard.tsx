...
export function ProductCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -2 }}
      className="bg-surface rounded-[22px] border border-on-surface/[0.07] p-[18px_20px_18px_18px] flex items-center gap-[18px] relative group transition-shadow hover:shadow-[0_8px_32px_rgba(0,0,0,0.18)] dark:hover:shadow-[0_10px_36px_rgba(0,0,0,0.45)]"
    >
      {/* Link badge */}
      {isLinked && (
        <button
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        {/* Name */}
        <p className="text-[17px] font-extrabold text-on-surface leading-[1.35] tracking-[-0.2px] mb-2 truncate">
          {name}
          {is_mother && (
